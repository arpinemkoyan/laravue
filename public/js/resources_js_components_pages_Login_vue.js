  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-2 flex flex-col",
        },
        [
          _c("h1", { staticClass: "text-gray-600 py-5 font-bold text-3xl" }, [
            _vm._v(" Login "),
          ]),
          _vm._v(" "),
          _vm._l(_vm.errors, function (value, index) {
            return typeof _vm.errors === "object"
              ? _c(
                  "ul",
                  { key: index, staticClass: "list-disc text-red-400" },
                  [_c("li", [_vm._v(_vm._s(value[0]))])]
                )
              : _vm._e()
          }),
          _vm._v(" "),
          typeof _vm.errors === "string"
            ? _c("p", { staticClass: "list-disc text-red-400" }, [
